...
const uiTranslations = {
  en: {
    ...
    "語系提醒：開始製作後請不要在中文 / English 之間隨意切換；語系會影響 LLM 產生的學習目標、內容、能力與學習單架構。": "Language reminder: after you start building a worksheet, do not switch casually between Chinese and English. The selected language affects the goals, content, competencies, and worksheet structure generated by the LLM.",
